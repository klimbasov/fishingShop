...
public class CommandsAlias {
    public static class Get {
        ...
        public static final String TO_PRODUCTS = "products";
        public static final String TO_PRODUCT = "product";
        public static final String TO_ORDERS = "orders";
        ...
        public static final String TO_ADMINISTRATION = "administration";
    ...
    public static class Post {
        ...
        public static final String SING_OUT = "signOut";
        ...
        public static final String OUT_BASKET = "outBasket";
