...
public class ArgumentValidator {
    ...
    public static void validate(final String str) {
        if (isNull(str)) {
            throw new IllegalArgumentException("Object or Some necessary fields were null");
        }
    }
    ...
    public static void validate(final int... uInts) {
        for (int uInt : uInts) {
            if (uInt < 0) {
                throw new IllegalArgumentException("Invalid integer argument value was set (" + uInt + ")");
            }
        }
    ...
    public static void validateId(final int id) {
        if (id <= 0) {
            throw new IllegalArgumentException("Invalid integer argument value was set (" + id + ")");
        }
    }
    ...
    public static void validate(final Product product) {
        ...
        if (isNull(product.getName())
            ...
            throw new IllegalArgumentException("Some necessary fields were null");
        }
    }
